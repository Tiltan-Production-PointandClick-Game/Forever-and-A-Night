	...
	public class MenuInventoryBox : MenuElement
	{
		...
		public override void RecalculateSize (MenuSource source)
		{
			if (inventoryBoxType == AC_InventoryBoxType.CollectedDocuments)
			{
				if (Application.isPlaying)
				{
					numDocuments = KickStarter.runtimeDocuments.CollectedDocumentIDs.Length;
					...
					{
						int documentID = KickStarter.runtimeDocuments.CollectedDocumentIDs[i + offset];
		...
		public Document GetDocument (int slotIndex)
		{
			...
			{
				slotIndex += offset;
				int documentID = KickStarter.runtimeDocuments.CollectedDocumentIDs [slotIndex + offset];
